...
from biolit.s3 import s3_bucket_name

LOGGER = structlog.get_logger()


def create_s3_client():
    # Réutilise le client centralisé (fallback aws_*/AWS_*/CELLAR_ADDON_* + schéma)
    from biolit.s3 import create_s3_client as _create_s3_client
